...
Airtable lets you sync bank transactions into a structured table within a base, giving you access to Airtable's filtering, grouping, and visualisation features.

<Info>
  Airtable currently supports **transaction syncs** from banking connections (AU and NZ). Brokerage data (holdings and trades) is available via [Google Sheets](/google-sheets).
</Info>
