---
title: "Syncs"
description: "Manage your bank-to-destination transaction syncs"
---

A sync links one bank account to one destination. Transactions flow from your bank into the destination automatically each day.
