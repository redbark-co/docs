...
<Info>
  Google Sheets supports all sync types — transactions, holdings, and trades. Airtable, Notion, and Actual Budget currently support transaction syncs only. Actual Budget runs as a separate Docker tool rather than a dashboard destination.
</Info>
